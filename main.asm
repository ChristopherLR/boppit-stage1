...
mainLoop:
  call t1_loop
	...
	call	set_led
pre_pause:
  ldi r24, 0x01   ; Set button to unchecked
  call	check_state
	rjmp mainLoop
...
check_state:
 ...
 ; cpi r24, 0x01 ; Check the button checked state
  ;//ldi r24, 0x00                 ; Set button checked state to checked = 0
...
check_win:
  andi r17, 0b00011111
  cpi r24, 0x01                 ; Check to see if we've already checked
  brne pause
  ldi r20, 0x14
  call SPI_Read_Command
  cpi r16, 0b00000100
...
set_led:
  ;; Toggle flag for direction of LED
	cpi r22, 0x01
	brsh led_up
led_down:
